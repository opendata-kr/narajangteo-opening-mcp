...
import { searchAwardsInputShape, runSearchAwards } from "./tools/searchAwards.js";
import { searchOpeningsInputShape, runSearchOpenings } from "./tools/searchOpenings.js";
import { getBidResultInputShape, runGetBidResult } from "./tools/getBidResult.js";
...
export function createServer(client: DataGoKrClient): McpServer {
  ...
  }, (args) => guard(() => runSearchAwards(client, args)));
  ...
  server.registerTool("search_openings", {
    ...
    annotations: READONLY,
  }, (args) => guard(() => runSearchOpenings(client, args)));
  ...
  server.registerTool("get_bid_result", {
    ...
    annotations: READONLY,
  }, (args) => guard(() => runGetBidResult(client, args)));
